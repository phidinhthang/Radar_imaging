$begin 'Profile'
	$begin 'ProfileGroup'
		...
		$begin 'StartInfo'
			I(1, 'Start Time', '07/10/2024 00:24:04')
		...
		$begin 'ProfileGroup'
			...
			GroupOptions=4
			TaskDataOptions('CPU Time'=8, Memory=8, 'Real Time'=8)
			ProfileItem('Mesh Assembler', 0, 0, 0, 0, 20700, 'I(2, 2, \'Triangles\', 3480, false, 2, \'Tetrahedra\', 0, false)', true, true)
		$end 'ProfileGroup'
		$begin 'ProfileGroup'
			MajorVer=2023
			MinorVer=2
			...
			$begin 'ProfileGroup'
				...
				ProfileItem('', 0, 0, 0, 0, 71664, 'I(1, 0, \'Disk = 0 kBytes, 1 task, multi-thread enabled, 3 cores per task\')', true, true)
				...
				ProfileItem('Data Transfer', 6, 0, 0, 0, 72540, 'I(1, 0, \'Discrete frequency sweep\')', true, true)
		...
		$end 'ProfileGroup'
		ProfileFootnote('I(2, 1, \'Stop Time\', \'07/10/2024 00:24:19\', 1, \'Status\', \'Normal Completion\')', 0)
	$end 'ProfileGroup'
$end 'Profile'
