$begin 'Profile'
	$begin 'ProfileGroup'
		...
		$begin 'StartInfo'
			I(1, 'Start Time', '07/10/2024 00:21:07')
		...
		$begin 'ProfileGroup'
			...
			GroupOptions=4
			TaskDataOptions('CPU Time'=8, Memory=8, 'Real Time'=8)
			ProfileItem('Mesh Assembler', 0, 0, 0, 0, 20780, 'I(2, 2, \'Triangles\', 3480, false, 2, \'Tetrahedra\', 0, false)', true, true)
		$end 'ProfileGroup'
		$begin 'ProfileGroup'
			MajorVer=2023
			MinorVer=2
			...
			$begin 'ProfileGroup'
				...
				ProfileItem('', 0, 0, 0, 0, 74376, 'I(1, 0, \'Disk = 0 kBytes, 1 task, multi-thread enabled, 3 cores per task\')', true, true)
				...
				ProfileItem('Data Transfer', 6, 0, 0, 0, 75400, 'I(1, 0, \'Discrete frequency sweep\')', true, true)
		...
		$begin 'ProfileGroup'
			...
			ProfileItem('Frequency Sweep', 0, 0, 0, 0, 0, 'I(5, 1, \'Elapsed Time\', \'00:00:13\', 1, \'Average memory/process\', \'24.2 MB\', 1, \'Max memory/process\', \'72.6 MB\', 2, \'Max number of processes/frequency\', 3, false, 2, \'Total number of cores\', 3, false)', false, true)
		$end 'ProfileGroup'
		ProfileFootnote('I(2, 1, \'Stop Time\', \'07/10/2024 00:21:22\', 1, \'Status\', \'Normal Completion\')', 0)
	$end 'ProfileGroup'
$end 'Profile'
