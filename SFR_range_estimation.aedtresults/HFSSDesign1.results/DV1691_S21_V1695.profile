$begin 'Profile'
	$begin 'ProfileGroup'
		...
		$begin 'StartInfo'
			I(1, 'Start Time', '07/10/2024 00:23:42')
		...
		$begin 'ProfileGroup'
			...
			GroupOptions=4
			TaskDataOptions('CPU Time'=8, Memory=8, 'Real Time'=8)
			ProfileItem('Mesh Assembler', 0, 0, 0, 0, 20748, 'I(2, 2, \'Triangles\', 3480, false, 2, \'Tetrahedra\', 0, false)', true, true)
		$end 'ProfileGroup'
		$begin 'ProfileGroup'
			MajorVer=2023
			MinorVer=2
			...
			$begin 'ProfileGroup'
				...
				ProfileItem('', 0, 0, 0, 0, 71024, 'I(1, 0, \'Disk = 0 kBytes, 1 task, multi-thread enabled, 3 cores per task\')', true, true)
				ProfileItem('SBR Ray Stats', 0, 0, 0, 0, 0, 'I(1, 0, \'Num Launched = 1568; Num Blocked = 1912; Num Escaped = 1568; Num Contributed = 1568\')', false, true)
				ProfileItem('', 0, 0, 0, 0, 0, 'I(1, 0, \'(Refl Depth, Num Branches Escape/Terminate at) = (1,1568)\')', false, true)
				ProfileItem('Data Transfer', 6, 0, 0, 0, 71888, 'I(1, 0, \'Discrete frequency sweep\')', true, true)
		...
		$end 'ProfileGroup'
		ProfileFootnote('I(2, 1, \'Stop Time\', \'07/10/2024 00:23:57\', 1, \'Status\', \'Normal Completion\')', 0)
	$end 'ProfileGroup'
$end 'Profile'
