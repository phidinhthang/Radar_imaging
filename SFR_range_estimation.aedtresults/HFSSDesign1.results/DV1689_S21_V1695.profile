$begin 'Profile'
	$begin 'ProfileGroup'
		...
		$begin 'StartInfo'
			I(1, 'Start Time', '07/10/2024 00:22:58')
		...
		$begin 'ProfileGroup'
			...
			$begin 'ProfileGroup'
				...
				ProfileItem('', 0, 0, 0, 0, 71676, 'I(1, 0, \'Disk = 0 kBytes, 1 task, multi-thread enabled, 3 cores per task\')', true, true)
				ProfileItem('SBR Ray Stats', 0, 0, 0, 0, 0, 'I(1, 0, \'Num Launched = 1528; Num Blocked = 1952; Num Escaped = 1528; Num Contributed = 1528\')', false, true)
				ProfileItem('', 0, 0, 0, 0, 0, 'I(1, 0, \'(Refl Depth, Num Branches Escape/Terminate at) = (1,1528)\')', false, true)
				ProfileItem('Data Transfer', 6, 0, 0, 0, 72412, 'I(1, 0, \'Discrete frequency sweep\')', true, true)
		...
		$begin 'ProfileGroup'
			...
			ProfileItem('Frequency Sweep', 0, 0, 0, 0, 0, 'I(5, 1, \'Elapsed Time\', \'00:00:14\', 1, \'Average memory/process\', \'23.3 MB\', 1, \'Max memory/process\', \'70 MB\', 2, \'Max number of processes/frequency\', 3, false, 2, \'Total number of cores\', 3, false)', false, true)
		$end 'ProfileGroup'
		ProfileFootnote('I(2, 1, \'Stop Time\', \'07/10/2024 00:23:12\', 1, \'Status\', \'Normal Completion\')', 0)
	$end 'ProfileGroup'
$end 'Profile'
